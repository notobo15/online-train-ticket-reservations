...
public class BookingController {
    ...
    // .filter(seat -> seat.getCarriage().getCarriageId().equals(carriageId)) //
    // Kiểm tra Carriage
...
//    }
    ...
    // public ResponseEntity<?> searchTrains(@Valid @RequestBody BookingFormDto
    ...
    // railwayRouteService.findRailwayRouteWithStations(
    // form.getDepartureStationId(),
    // form.getDestinationStationId(),
    // form.getDepartureDate());
    //
    // if (availableTrains.isEmpty()) {
    // return ResponseEntity.status(HttpStatus.NOT_FOUND).body("No trains found for
    // the given criteria.");
    // }
    //
